...
const PurpleHomeScreen = ({ onTabChange }: PurpleHomeScreenProps) => {
  return (
    <div className="mobile-container gradient-purple min-h-screen flex flex-col">
      ...
      <BottomTabBar theme="purple" activeTab="Home" onTabChange={onTabChange} />
    </div>
  );
};

export default PurpleHomeScreen;
