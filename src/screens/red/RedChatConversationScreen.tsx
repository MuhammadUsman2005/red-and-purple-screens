...
interface RedChatConversationScreenProps {
  contactName?: string;
  onBack?: () => void;
}

const RedChatConversationScreen = ({ 
  contactName = "Ali Akbar", 
  onBack 
}: RedChatConversationScreenProps) => {
  return (
    <div className="mobile-container gradient-red min-h-screen flex flex-col">
      ...
      <div className="flex-1 px-4 py-4 overflow-y-auto">
        ...
        <div className="flex justify-start mb-3">
          <div className="bg-white rounded-2xl rounded-tl-sm px-4 py-2 max-w-[70%]">
            <p className="text-foreground text-sm">Hello world</p>
          </div>
        </div>
      ...
      <div className="px-4 py-3 bg-black/20">
        <div className="flex items-center gap-3">
          ...
          <button className="text-red-accent">
...
export default RedChatConversationScreen;
