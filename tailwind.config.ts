    ...
    extend: {
      ...
      colors: {
        ...
        red: {
          ...
          surface: "hsl(var(--red-surface))",
          "surface-light": "hsl(var(--red-surface-light))",
        },
        // Purple theme
        purple: {
          ...
          "surface-light": "hsl(var(--purple-surface-light))",
        },
        // UI specific
        verified: "hsl(var(--verified-blue))",
        online: "hsl(var(--online-green))",
        star: "hsl(var(--star-orange))",
      ...
      boxShadow: {
        ...
        "card-red": "0 4px 20px rgba(0, 0, 0, 0.3)",
        "card-purple": "0 4px 20px rgba(0, 0, 0, 0.4)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
